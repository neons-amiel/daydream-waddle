    ...
    <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 animate-fadeIn">
      <div className="bg-white dark:bg-zinc-900 border-2 border-zinc-200 dark:border-zinc-800 p-6 md:p-8 rounded-[2rem] shadow-2xl max-w-md w-full relative transition-colors duration-300">
        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <h3 className="text-xl font-extrabold text-zinc-900 dark:text-zinc-100">How Daydream Works</h3>
        </div>

        {/* Simple, Human Copy */}
        <div className="space-y-4 text-zinc-600 dark:text-zinc-300 font-medium leading-relaxed text-sm md:text-base">
          <p>
            Input your earnings and expenses to estimate how long it will take to buy your next goal item.
          </p>
          <p>
            It also works as <span className="font-bold text-teal-600 dark:text-teal-400">a simple monthly tracker to show you how much money you have left over</span> after paying for everything.
          </p>
        </div>
